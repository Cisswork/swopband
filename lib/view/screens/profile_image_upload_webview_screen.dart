    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Your profile image has been uploaded. Would you like to update your profile with this image?'),
          actions: [
            TextButton(
              onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: MyColors.textBlack),
          onPressed: () => Get.back(),
        ),
        actions: [
          IconButton(
            icon: Icon(Icons.refresh, color: MyColors.textBlack),
            onPressed: () {
              _controller.reload();
            },
          ),
